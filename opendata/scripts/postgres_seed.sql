...
COPY objects_terms FROM '/app/data/objects_terms.csv' WITH (FORMAT csv, header);
...
COPY objects_constituents FROM '/app/data/objects_constituents.csv' WITH (FORMAT csv, header);
...
COPY constituents FROM '/app/data/constituents.csv' WITH (FORMAT csv, header);
...
COPY media_relationships FROM '/app/data/media_relationships.csv' WITH (FORMAT csv, header);
...
COPY media_items FROM '/app/data/media_items.csv' WITH (FORMAT csv, header);